...
class AppColors {
  static const Color primaryColor = Color(0xFF16423C); // Primary color
  static const Color hintColor = Color(0xFF909090); // Hint color
  static const Color cardBackgroundColor =
  Color(0xFFC4DAD2); // Card background color
  static const Color categoryBackgroundColor =
  Color(0xFF6A9C89); // Card background color
